...
//        return textView;
        ...
        this.uwReactietijdView = (EditText) v.findViewById(R.id.reactietijdtxt);
        this.uwSnelheidView = (EditText) v.findViewById(R.id.snelheidtxt);
        this.uwStopafstandView = (TextView) v.findViewById(R.id.stopAfstandIstxt);
//        this.droogWegTypeView = (RadioButton) v.findViewById(R.id.radioGroup);
    ...
    public void toonStopAfstand(View v)
    {
        ...
        int stopafstant = Integer.parseInt(this.uwStopafstandView.getText().toString());

...
public class BitcoinRateFragment extends Fragment {
    ...
    private double rate1BitcoinInEuros = 254.4f;
    private EditText euro;
    private Button wijzigen;
     ...
     * @return A new instance of fragment BitcoinRateFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BitcoinRateFragment newInstance(String param1, String param2) {
...
//        return inflater.inflate(R.layout.fragment_bitcoinrate, container, false);
        View v = inflater.inflate(R.layout.fragment_bitcoinrate, container, false);
        euro = (EditText) v.findViewById(R.id.txtexchange);
        wijzigen = (Button) v.findViewById(R.id.btnwijzigen);
        wijzigen.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void rateChanger() {
        rate1BitcoinInEuros = Double.valueOf(euro.getText().toString());
    }
